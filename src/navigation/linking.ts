...
import { tabsFor, type AccessProfile } from './roleConfig';
...
export const linkingConfig: LinkingOptions<AppTabParamList>['config'] = {
  screens: {
    ...
    Stock: { screens: { StockList: 'stock' } },
    Products: { screens: { ProductsList: 'products' } },
...
export function buildLinking(profile: AccessProfile): LinkingOptions<AppTabParamList> {
  return {
     ...
     * a role that cannot use it, nothing to see. Those links resolve to Home.
     *
