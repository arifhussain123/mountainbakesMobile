...
import { MBButton, MBCard } from '@/components';
import type { ConflictRecord } from '@/database/repositories/conflictRepository';
import { policyFor, type ConflictResolution } from '@/services/sync/conflicts';
