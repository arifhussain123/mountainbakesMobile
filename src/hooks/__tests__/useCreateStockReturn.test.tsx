...
jest.mock('@/services/sync/writeOutcome', () => ({ resolveWriteOutcome: jest.fn() }));
...
import { resolveWriteOutcome } from '@/services/sync/writeOutcome';
import { useCreateStockReturn, type CreateStockReturnResult } from '@/hooks/useCreateStockReturn';
